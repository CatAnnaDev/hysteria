...
float cfg_get_float(const char *mod, const char *key, float def);
int   cfg_get_bool(const char *mod, const char *key, int def);
void  cfg_set_int(const char *mod, const char *key, int val);
void  cfg_set_float(const char *mod, const char *key, float val);
void  cfg_set_bool(const char *mod, const char *key, int val);
...
extern int g_fovOverride, g_labels, g_healthbars, g_box3d;
extern char g_renderer[80];
