class SeqAct_Respawn extends SeqAct_SetDeath
    native
    notplaceable
    hidecategories(Object);

var PathNode RespawnLocation;
var() int HealthToRemove;
var() bool bRefillHealth;
...
defaultproperties
{
    ...
    VariableLinks(1)=(ExpectedType="Engine.SeqVar_Object",LinkedVariables=(),LinkDesc="Path Node",LinkVar="None",PropertyName="RespawnLocation",bWriteable=False,bModifiesLinkedObject=False,bHidden=False,MinVars=1,MaxVars=255,DrawX=0,CachedProperty="None",bAllowAnyType=False,bMoving=False,bClampedMax=False,bClampedMin=False,OverrideDelta=0)
    ObjName="Respawn"
}
