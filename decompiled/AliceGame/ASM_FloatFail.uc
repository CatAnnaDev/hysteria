class ASM_FloatFail extends AliceSpecialMove
    notplaceable;
...
function SpecialMoveEnded(ESpecialMove PrevMove, ESpecialMove NextMove)
{
    ...
    PawnOwner.StopConfigAnim(AnimCfg_Animation, 1.0);
    PawnOwner.DoSpecialMove(3, true);
    PCOwner.bJustAfterFloatFail = true;
}
