class ASM_SwimIdleToForward extends AliceSpecialMove
    notplaceable;
...
function SpecialMoveEnded(ESpecialMove PrevMove, ESpecialMove NextMove)
{
    ...
    AlicePawn(PawnOwner).bIdleToSwimEnd = true;
}
